...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__games_Lect_vue__ = __webpack_require__(53);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__games_Cycle_vue__ = __webpack_require__(51);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Sections_vue__ = __webpack_require__(50);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__model_CardMain_vue__ = __webpack_require__(58);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ItemCycle_vue__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ItemCycle_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__ItemCycle_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            correct: 0,
            progress: 0,
            codes: ['i=i+1; s=s+i*i; s;', '{i=i+1;s=s+i*i;} s;', '{s=s+i*i;i=i+1;} s;', 'i=i-1; s=s+i*i; s;', '{i=i-1;s=s+i*i;} s;', '{s=s+i*i;i=i-1;} s;']
        };
    },

    methods: {
        generate: function generate(string, isInc) {
            var params = void 0,
    ...
    created: function created() {
        ...
        this.codes = this.codes.map(function (item, index) {
            return _this.generate(item, index < 3);
        });
        this.$parent.shuffle(this.codes);
        this.$on('setResult', function (correct) {
            console.log('setResult', correct);
            _this.correct += correct;
            _this.progress++;

            if (_this.progress == _this.codes.length) {
                setTimeout(function () {
                    _this.$router.push({
                        name: 'res',
                        params: { result: _this.correct / _this.progress * 100, resId: _this.$route.params.gameId }
                    });
                }, 2000);
            }
        });
    ...
    components: {
        ItemCycle: __WEBPACK_IMPORTED_MODULE_0__ItemCycle_vue___default.a
    }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        ...
        convertCode: function convertCode() {
            ...
            var commands = ['while', 'do', 'begin', 'end;'];
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lecture_Shape_vue__ = __webpack_require__(55);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__lecture_Text_vue__ = __webpack_require__(56);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lecture_Image_vue__ = __webpack_require__(54);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__lecture_Video_vue__ = __webpack_require__(57);
...
// module
exports.push([module.i, ".img{background-position:50%;background-repeat:no-repeat}.hover-text,.img{position:absolute;height:100%;width:100%;top:0;left:0}.hover-text{background-color:#fff}", ""]);
...
// module
exports.push([module.i, ".textField input,.textField label{margin:0 20px;font-size:1.5em}.btnPause,.btnPlay{left:50%;top:50%;margin-left:-28px;margin-top:-28px}.btnPause{opacity:0}", ""]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('v-app', {
    ...
    attrs: {
      "href": "http://der.nis.edu.kz/feedback2/index.html?id=inf20179",
      "target": "_blank",
      "icon": ""
    }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('h5', [_vm._v(_vm._s(_vm.items.task))]), _vm._v(" "), _vm._l((_vm.codes), function(code) {
    return _c('item-cycle', {
      attrs: {
        "items": code
      }
    })
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('v-card', {
    staticClass: "pt-4 pr-4 pl-4 mb-5"
  }, [_c('h4', {
    staticClass: "ml-4"
  }, [_c('span', {
    domProps: {
    ...
    attrs: {
      "disabled": _vm.checked != null,
      "type": "number",
      "label": _vm.$lang.string.answer
    },
    model: {
      value: (_vm.answer),
      callback: function($$v) {
  ...
  }), _vm._v(" "), (_vm.checked == null) ? _c('v-btn', {
    staticClass: "mbtn",
    attrs: {
      "disabled": !_vm.answer,
      "primary": "",
  ...
  }, [_vm._v("\n            " + _vm._s(_vm.$lang.string.check) + "\n        ")]) : (_vm.checked) ? _c('v-btn', {
    staticClass: "success elevation-0",
    attrs: {
      "dark": "",
      "small": "",
      "fab": ""
    ...
    staticClass: "error elevation-0",
    attrs: {
      "dark": "",
      "small": "",
      "fab": ""
    }
  }, [_c('v-icon', [_vm._v("close")])], 1), _vm._v(" "), _c('transition', {
    attrs: {
      "name": "bounce"
    }
  }, [(_vm.checked == false) ? _c('h6', {
    staticClass: "pa-2"
  }, [_vm._v("\n                " + _vm._s(_vm.$lang.string.correctAnswer) + "\n                "), _c('b', [_vm._v(_vm._s(_vm.getValue))])]) : _vm._e()])], 1)], 1)
},staticRenderFns: []}
...
var update = __webpack_require__(2)("6622169a", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("a925f78e", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("32b32c89", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("634b45df", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("0776f717", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("6c1890cb", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("ae7c4094", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("cd6e7454", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("3dfbe0fd", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("4b9d1a3a", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("62aad11e", content, true);
